...
export const listOfAwesome = [
  { id: '1', name: 'Dionne Stratton' },
  { id: '2', name: 'Elijah Paminasan' },
  { id: '3', name: 'Nathan Patterson' },
      ...
      <div className='programmers'>
        {
          ...
          programmerArray.map(dev =>
            <div className='programmer' key={dev.id}>
              {dev.name} <button onClick={() => {featuredProgrammer !== dev.id ? setFeatured(dev.id): setFeatured('');}}>Feature</button>
            </div>
          )
        }
      </div>
